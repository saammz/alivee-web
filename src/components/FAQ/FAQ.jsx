...
export const FAQ = () => {
  return (
    <div className="flex flex-col gap-4 pb-20 p-8 items-center justify-center bg-[#87CEEB20]">
      <div className="flex flex-col lg:flex-row  items-center justify-center">
        <div>
          <h1 className="text-[54px] text-center font-bold text-black mb-4 max-w-xl">
