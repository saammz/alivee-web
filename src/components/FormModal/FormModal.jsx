...
const Modal = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50  sm-max:px-4">
      <div className="relative bg-white rounded-lg p-8 shadow-xl w-full sm:w-96">
        <button className="absolute top-1 right-1 p-2 bg-gray-100 rounded-full hover:bg-gray-300 transition-colors duration-300" onClick={onClose}>
