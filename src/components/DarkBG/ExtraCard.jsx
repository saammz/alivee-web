      ...
      <div className="extra-card">
        <div className="extra-abs relative w-full h-full bg-[#d7e8f0] rounded-2xl overflow-hidden">
          <img
            src={comunity}
            alt=""
            className="absolute object-cover h-full right-0 top-0 w-[50%] rounded-r-2xl filter-blur-left md-max:w-full sm:max-h-[85vh] sm-max:w-full md:max-h-full"
          />

          <div className="absolute inset-0 bg-[#d7e8f0] opacity-30 w-[50%] h-full md-max:bg-black md-max:w-full md-max:opacity-60 sm-max:bg-black sm-max:w-full sm-max:opacity-60"></div>

          <div className="absolute flex flex-col items-start justify-start gap-2 mt-6 mx-6">
            <h1 className="text-3xl text-black font-bold sm-max:w-full sm-max:text-2xl md-max:text-white sm-max:text-white">
              Community Support:
            </h1>
            <div className=" w-[73%] flex flex-col gap-4 sm-max:w-full xsm-max:gap-3">
              <div className="flex items-start gap-1 text-[15px] text-black font-semibold md-max:text-white sm-max:text-white sm-max:text-[16px]">
