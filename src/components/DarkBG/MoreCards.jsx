      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center justify-center gap-8 sm-max:flex sm-max:flex-col mt-12">
          <div className="flex flex-col items-center justify-center gap-8">
            <div className="flex justify-between px-1 bg-[#d8e8f0] w-[480px] h-[250px] md-max:w-[365px] rounded-2xl md:rounded-20">
              <div className="p-8 pr-0">
                <h3 className="text-4xl leading-32 md:text-40 md:leading-40 font-semibold text-black md-max:text-3xl">
                  Connect with your devices
                </h3>
                <h4 className="text-2xl leading-18 md:text-20 md:leading-20 font-medium mt-6 text-black">
            ...
            <div className="relative w-[480px] h-[625px] rounded-2xl md:rounded-20 md-max:w-[365px]">
            ...
            <div className="w-[480px] h-[625px] md-max:w-[365px] rounded-2xl md:rounded-20 bg-[#ebad40] px-7 flex flex-col items-center">
              <div>
                <img src={audio} alt="" className="rounded-t-2xl" />
              </div>
              <div className="mr-auto px-6">
                <h3 className="text-5xl leading-32 md:text-40 md:leading-40 font-bold text-black">
          ...
          <div className="flex flex-col gap-6">
            <div className="h-[590px] w-[480px] md-max:w-[365px]  rounded-2xl md:rounded-20 bg-center bg-cover flex flex-col items-center justify-between p-0 bg-yellow-medium overflow-hidden bg-[#ebad40]">
              <div className="p-8">
            ...
            <div className="h-[580px] w-[480px] md-max:w-[365px] rounded-2xl md:rounded-20 bg-center bg-cover flex flex-col items-center justify-between p-0 bg-yellow-medium overflow-hidden bg-[#0a1b22]">
              <div className="p-8">
            ...
            <div className="h-[630px] w-[480px] md-max:w-[365px] rounded-2xl md:rounded-20 bg-center bg-cover flex flex-col items-center justify-between p-0 bg-yellow-medium overflow-hidden bg-[#091b20]">
              <img
                alt="what youget empowering"
                loading="lazy"
                width="535"
